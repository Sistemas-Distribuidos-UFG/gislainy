...
class Response extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Response', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'questions'), createEmptyInstance: create)
...
class Employee extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Employee', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'questions'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'role')
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'salary', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.double get salary => $_getN(2);
  @$pb.TagNumber(3)
  set salary($core.double v) { $_setFloat(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasSalary() => $_has(2);
  @$pb.TagNumber(3)
  void clearSalary() => clearField(3);
}
